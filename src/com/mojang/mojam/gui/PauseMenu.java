...
public class PauseMenu {
	...
	symbol.draw(xPos - symbol.getWidth() / 2,
		yPos - symbol.getHeight() / 2);

	BUTTON[0].setPos(xPos - BUTTON[0].getWidth() - 125, yPos - symbol.getHeight() / 4);
	BUTTON[1].setPos(xPos + 125, yPos - symbol.getHeight() / 4);
	BUTTON[2].setPos(xPos - BUTTON[2].getWidth() / 2, yPos + symbol.getHeight()/2 + 25);
