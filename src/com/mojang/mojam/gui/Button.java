...
public class Button extends Image {
	...
	private UnicodeFont font = new UnicodeFont("fonts/Meltdown.ttf", 32, false,
			false);
	...
	public Button(String buttonText) throws SlickException {
		this.buttonText = buttonText;
		this.initFont();
	}

	public Button(String buttonText, Color buttonColor) throws SlickException {
		this.setPos(xPos, yPos);
		this.buttonText = buttonText;
		this.buttonColor = buttonColor;
		this.initFont();
