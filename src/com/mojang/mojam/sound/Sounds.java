...
public class Sounds {
	...
	public static final String COIN_1 = "coin1.wav";
	public static final String COIN_2 = "coin2.wav";
	public static final String COIN_3 = "coin3.wav";
	...
	public void playSound(String name, float x, float y, float z, float pitch,
			float volume) {
		...
		// float dist = (float) Math.sqrt((double) (dx * dx + dy * dy + dz *
		// dz));
