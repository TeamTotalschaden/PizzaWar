...
public class AlienProjectile extends Projectile {
	...
	public AlienProjectile(PizzaWorld world, float x, float y, float z,
			Vector3f direction, float speed) {
		super(world, x, y, z, direction, speed);

		damage = 40;
		try {
			bulletImage = new OffsetImage("projectiles/alienbullet.png");
	...
	public void onCollide(Entity entity) {
		if (entity instanceof Player || entity instanceof PizzaBubble) {
			...
			healthEntity
					.push(new Vector3f(direction.x * 5, 0, direction.z * 5));
